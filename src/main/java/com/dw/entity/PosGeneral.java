 ...
 * 普通日子表 实体类
 */
@TableName("tb_pos_general")
@Accessors(chain = true)
@NoArgsConstructor
@Getter
@Setter
@ToString
public class PosGeneral implements Serializable {
    @TableField("ID")
    private String id; //
    @TableField("version")
    @Builder.Default
    ...
    @TableField("ROOM_DESC1")
    private String roomDesc1; //包房时段名称  
    @TableField("ROOM_TIME2")
    private Date roomTime2; //包房时段2     
    @TableField("ROOM_DESC2")
    private String roomDesc2; //包房时段2名称 
    @TableField("ROOM_TIME3")
    private Date roomTime3; //包房时段3     
    @TableField("ROOM_DESC3")
    private String roomDesc3; //包房时段3名称 
    @TableField("PERIOD_1")
    @DateTimeFormat(pattern = "HH:mm:ss")
